...
public class LoginFunctionality {
    ...
    public static void main(String[] args) {
        ...
        PassWord.sendKeys("UserUser123");  //truck driver password
        BrowserUtils.wait(6);
        ...
        if(expectedResult.equals(actualResult)){
            System.out.println("Test passed HAPPY HALOWEEN");  //if the sign in was successful
        }else{
            System.out.println("Test failed"); // if the sign in  failed
        }
        BrowserUtils.wait(3);
